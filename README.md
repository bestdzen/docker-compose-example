...
1. Включение опции proxy_protocol на балансировщике.
2. Доавление опций real_ip_header proxy_protocol и set_real_ip_from proxy на бэкэнд веб серверах.
3. Установка опции proxy_protocol в директиве listen на бэкэндах.
